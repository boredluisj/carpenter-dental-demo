...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Anne Carpenter, DDS</title>
        <meta name="description" content="Privacy Policy and HIPAA compliance information for Dr. Anne M. Carpenter's dental practice in Houston." />
      </Helmet>
      ...
      <section className="py-20 bg-surface">
        <div className="max-w-4xl mx-auto px-6 prose prose-lg prose-slate">
          ...
          <p>
            Anne Carpenter, DDS ("we," "our," or "us") respects your privacy and is committed to protecting your personal and medical information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
          </p>
          ...
          <p>
            We will never sell, rent, or share your PHI with unauthorized third parties. Your information is only accessed by Dr. Carpenter, treating dental staff, and necessary administrative personnel for the purposes of your treatment and billing.
          </p>
          ...
          <ul>
            <li>To evaluate your candidacy for aesthetic and restorative procedures.</li>
          ...
          <p>
            ...
            Email: office@annecarpenterdds.com<br/>
            Phone: (281) 497-5001
          </p>
        </div>
      </section>
