      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1 border-r border-gray-800 pr-8">
            <Link to="/" onClick={handleScrollToTop} className="inline-block mb-6">
              <ApexLogo className="[&_span]:text-white" />
            </Link>
            <p className="text-gray-400 mb-6 text-sm leading-relaxed">
              Dr. Anne M. Carpenter provides patients of all ages with exceptional, personalized dental care in a comfortable and relaxing environment in Houston, TX.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-400 text-sm">
                ...
                <span>12121 Richmond Avenue<br/>Suite 219<br/>Houston, TX 77082</span>
              </li>
              ...
              <li className="flex items-center gap-3 text-gray-400 text-sm">
                ...
                <span>contact@cosmeticdentisthoustontx.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm text-center md:text-left">
            &copy; {new Date().getFullYear()} Anne M. Carpenter, DDS. All rights reserved.
          </p>
